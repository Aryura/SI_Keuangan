...
//        db.connection();
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(0, 37, 53));
        jButton2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton2.setForeground(new java.awt.Color(191, 210, 217));
        jButton2.setText("Login");
        jButton2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(191, 210, 217), 2));
        ...
        jPasswordField1.setBackground(new java.awt.Color(0, 56, 81));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ResultSet login = db.login(us, pass);
            if (login.next()) {
