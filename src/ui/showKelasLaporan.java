 ...
 * @author maula
 */
public class showKelasLaporan extends javax.swing.JFrame {
...
//                int a = tba.getInt("id");
    ...
    private void ambilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ambilActionPerformed
        ...
        int bar = tblguru.getSelectedRow();
        String nkelas = tabmode.getValueAt(bar, 1).toString();
        lp.tkelas.setText(nkelas);
        dispose();
        lp.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showKelasLaporan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showKelasLaporan().setVisible(true);
            }
        });
    }
