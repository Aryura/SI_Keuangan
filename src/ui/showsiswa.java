 ...
 * @author maula
 */
public class showsiswa extends javax.swing.JFrame {
...
//                int a = tba.getInt("id");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showsiswa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
